			...
			while (i++ < 255) 
			{
				...
				while (c) 
				{
					...
					if( 0 < (c._z = focalLength + c.x * m02 + c.y * m06 + c.z * m10 + m14) )
					{
						...
						meta = material.meta[s > material.resolution ? material.resolution : (s < 0 ? 0 : s)];
