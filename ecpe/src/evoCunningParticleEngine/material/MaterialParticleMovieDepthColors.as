package evoCunningParticleEngine.material
{
	...
	public class MaterialParticleMovieDepthColors implements IMaterialParticle
	{
		...
		public function MaterialParticleMovieDepthColors(movie:MovieClip, resolution:int = 128, lightResolution:int = 16, lightAmbient:Number = 0, range:int = 50000, maxSize:Number = 0, dof:Number = 0, r:Number = 1, g:Number = 1, b:Number = 1, brightness:Number = 0, toDark:Boolean = true)
		{
